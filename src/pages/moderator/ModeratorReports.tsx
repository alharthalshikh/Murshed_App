...
export default function ModeratorReports() {
    ...
    const {
        ...
        queryKey: ['moderator', 'reports', filters],
                                        ...
                                        <tr key={report.id} className="hover:bg-muted/30 transition-colors">
                                            ...
                                            <td className="p-4">
                                                <Badge variant={report.type === 'lost' ? 'destructive' : 'success'}>
                                                    {report.type === 'lost' ? t('stat_lost') : t('stat_found')}
                                                </Badge>
                                            </td>
                                            <td className="p-4 text-sm">
                                                {t(`cat_${report.category}` as any) || report.category}
                                            </td>
                                            <td className="p-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <Badge variant={selectedReport.type === 'lost' ? 'destructive' : 'success'} className="mt-1">
                                        {selectedReport.type === 'lost' ? t('stat_lost') : t('stat_found')}
                                    </Badge>
                                </div>
                                <div>
                                    <p className="text-sm text-muted-foreground">{t('table_category')}</p>
                                    <p className="font-medium mt-1">{t(`cat_${selectedReport.category}` as any)}</p>
                                </div>
                                <div>
